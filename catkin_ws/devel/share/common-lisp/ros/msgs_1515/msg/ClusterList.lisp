...
(cl:defmethod cl:initialize-instance :after ((m <ClusterList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClusterList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_1515-msg:<ClusterList> is deprecated: use msgs_1515-msg:ClusterList instead.")))
