...
(cl:defmethod cl:initialize-instance :after ((m <ContiList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ContiList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_1515-msg:<ContiList> is deprecated: use msgs_1515-msg:ContiList instead.")))

(cl:ensure-generic-function 'nof_objects-val :lambda-list '(m))
(cl:defmethod nof_objects-val ((m <ContiList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_1515-msg:nof_objects-val is deprecated.  Use msgs_1515-msg:nof_objects instead.")
  (nof_objects m))
