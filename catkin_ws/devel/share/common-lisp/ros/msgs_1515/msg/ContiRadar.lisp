...
(cl:defmethod cl:initialize-instance :after ((m <ContiRadar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ContiRadar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_1515-msg:<ContiRadar> is deprecated: use msgs_1515-msg:ContiRadar instead.")))
...
(cl:defmethod obstacle_id-val ((m <ContiRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_1515-msg:obstacle_id-val is deprecated.  Use msgs_1515-msg:obstacle_id instead.")
  (obstacle_id m))
...
(cl:defmethod orientation_angle-val ((m <ContiRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_1515-msg:orientation_angle-val is deprecated.  Use msgs_1515-msg:orientation_angle instead.")
  (orientation_angle m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <ContiRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_1515-msg:length-val is deprecated.  Use msgs_1515-msg:length instead.")
  (length m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <ContiRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_1515-msg:width-val is deprecated.  Use msgs_1515-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'prob_exist-val :lambda-list '(m))
(cl:defmethod prob_exist-val ((m <ContiRadar>))
...
(cl:defmethod dyn_property-val ((m <ContiRadar>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ContiRadar>)))
  ...
  (cl:format cl:nil "Header header~%uint8 obstacle_id~%float32 longitude_dist~%float32 lateral_dist~%float32 longitude_vel~%float32 lateral_vel~%float32 rcs~%float32 orientation_angle~%float32 length~%float32 width~%float32 prob_exist~%string obstacle_class~%string dyn_property~%uint8 meas_state~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ContiRadar)))
  "Returns full string definition for message of type 'ContiRadar"
  (cl:format cl:nil "Header header~%uint8 obstacle_id~%float32 longitude_dist~%float32 lateral_dist~%float32 longitude_vel~%float32 lateral_vel~%float32 rcs~%float32 orientation_angle~%float32 length~%float32 width~%float32 prob_exist~%string obstacle_class~%string dyn_property~%uint8 meas_state~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
