...
class BestTrajectory {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Trajectory.serialize(obj.waypoints, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BestTrajectory(null);
    ...
    data.waypoints = Trajectory.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BestTrajectory(null);
    ...
    if (msg.waypoints !== undefined) {
      resolved.waypoints = Trajectory.Resolve(msg.waypoints)
    }
    else {
      resolved.waypoints = new Trajectory()
    }
