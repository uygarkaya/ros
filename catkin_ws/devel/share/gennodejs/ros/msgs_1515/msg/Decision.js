...
class Decision {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('lane_values')) {
        this.lane_values = initObj.lane_values
      }
      else {
        this.lane_values = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [lane_values]
    bufferOffset = _arraySerializer.float32(obj.lane_values, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [lane_values]
    data.lane_values = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.lane_values.length;
    return length + 21;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.lane_values !== undefined) {
      resolved.lane_values = msg.lane_values;
    }
    else {
      resolved.lane_values = []
    }
